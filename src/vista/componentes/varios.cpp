...
sf::Text crearEtiqueta(
    const std::string &texto, int tamano_fuente, const sf::Color &color,
    const sf::Font &font, const sf::Vector2f &posicion
) {
...
sf::Text crearEtiqueta(
    const std::string &texto, const EstiloTexto &estilo, const sf::Font &font,
